                        ...
                        <form onSubmit={this.handleSubmit} className="p-5 bg-light">
                            ...
                            <div className="form-group">
                                ...
                                <div className="col-md-12">
                                    ...
                                    <input type="text" name="email" required className="lform form-control"/>
                                </div>
                            </div>
                            ...
                            <div className="form-group">
                                ...
                                <div className="col-md-12">
                                    ...
                                    <input type="password" name="password" required className="lform form-control"/>
                                </div>
                            </div>
                            ...
                            <div className="row form-group">
                                <div className="col-md-12 text-center">
                                    <input type="submit" value="Login" className="btn btn-primary btn-md text-white"/>
                                </div>
                            </div>

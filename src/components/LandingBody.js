    ...
    <div className="container text-center">
        <div className="row justify-content-center text-center">
            <div className="col-lg-10">
                <div className="mb-5">
                    <h1 className="hero-heading">Boost Business with <strong>vizards</strong></h1>
                    <p><strong>vizards</strong> lets you share your business profile to everyone within seconds.</p>
                    <a href="/login" className="btn btn-primary"><b>Create your Card</b></a>
                </div>
                <img src="static/images/untree.co_dashboard_mocklayout_laptop.png" alt="" className="img-fluid" />
            </div>
        </div>
    </div>
</div>
...
<div className="site-section pt-0" id="features-section">
    <div className="container">
        ...
        <div className="row align-items-center mb-5">
            <div className="col-lg-6 mb-5 order-lg-2 mb-lg-0" data-aos="fade-right">
                <img src="static/images/untree.co_dashboard_mocklayout.jpg" alt="" className="img-fluid img-shadow" />
            </div>

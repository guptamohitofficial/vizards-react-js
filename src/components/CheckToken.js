                ...
                <div className="row justify-content-center">
                    <div style={{marginTop:'15%'}} className="">
                        <div className="mb-2 site-logo">
                            <div style={{fontSize:"4em"}} className="mb-0 text-black">vizards<span className="text-primary">.</span></div>
                        </div>
                        <div className="text-center">
                            <div className="spinner-border text-primary" role="status">
                                <span className="sr-only"></span>
                            </div>
                            <span className="text-center text-primary" style={{fontSize:'2em'}}> Verifying User...</span>
                        </div>
                    </div>
                </div>
            </div>
